        ...
        >
          <div className="">
            ...
            <div className="flex justify-center mb-8">
              <div className='flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#6D28D9]/20 border border-[#6D28D9]/30 backdrop-blur-sm mix-blend-difference'>
            ...
            <h1
              className='font-display text-5xl md:text-7xl font-bold mb-8 max-w-5xl mx-auto text-white drop-shadow-sm uppercase mix-blend-difference transtion-all duration-300'
              style={{
                letterSpacing: 'var(--display-tracking, -0.08em)',
                lineHeight: 'var(--display-leading, 0.85)'
              }}
            >
            ...
            <p className='font-mono text-sm md:text-base text-zinc-300 max-w-2xl mx-auto mb-20 leading-relaxed tracking-wide font-medium mix-blend-difference'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-6 mb-32 relative pb-12 w-full max-w-lg mx-auto'>

            {/* CTA 1: Power Color Button */}
            <Link href='/contact' className='flex-1 w-full sm:w-auto group relative px-8 py-4 bg-[#6D28D9] text-white font-bold text-xs tracking-[0.15em] uppercase overflow-hidden rounded-sm shadow-none hover:shadow-[0_0_30px_rgba(109,40,217,0.4)] transition-all duration-300 text-center pointer-events-auto mix-blend-difference'>
            ...
            <Link href='#work' className='flex-1 w-full sm:w-auto px-6 py-4 rounded-sm border-2 border-[#a78bfa]/30 bg-transparent text-[#a78bfa] font-bold text-xs tracking-[0.15em] uppercase hover:bg-[#a78bfa]/10 hover:border-[#a78bfa] transition-all duration-300 flex items-center justify-center gap-2 text-center pointer-events-auto mix-blend-difference'>
              VER_PORTAFOLIO
            </Link>
          </div>
