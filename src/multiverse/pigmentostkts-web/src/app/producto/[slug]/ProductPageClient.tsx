        ...
        try {
            await fetch("/api/reviews", {
                ...
                body: JSON.stringify({
                    ...
                    authorEmail: reviewForm.email || null,
                }),
            });
                ...
                <div className="border-t border-gray-100 pt-12">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        {!reviewSubmitted && (
                            <button
                                ...
                                className="text-xs font-black bg-brand-black text-white px-5 py-2.5 rounded-xl hover:bg-brand-yellow hover:text-brand-black transition-all uppercase tracking-wider"
                            >
                                Escribir Reseña
                            </button>
                        )}
                        ...
                        {showReviewForm && (
                            ...
                            >
                                <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 space-y-4">
                                    <h3 className="text-sm font-black text-brand-black uppercase tracking-tight">Tu opinión importa</h3>

                                    {/* Stars */}
                                    <div>
                                        <p className="text-xs text-gray-500 font-bold mb-2">Calificación</p>
                                        <div className="flex gap-1">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                ...
                                                >
                                                    <Star
                                                        className={`w-7 h-7 transition-colors ${star <= reviewForm.rating ? "text-yellow-400 fill-yellow-400" : "text-gray-200 hover:text-yellow-300"
                                                            }`}
                                                    />
                                                </button>
                                            ))}
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <input
                                            ...
                                            className="text-sm px-4 py-3 border border-gray-200 rounded-xl focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow outline-none"
                                        />
                                        <input
                                            type="email"
                                    ...
                                    <button
                                        ...
                                        disabled={!reviewForm.name || !reviewForm.comment || submittingReview}
                    ...
                    {reviewSubmitted && (
                        ...
                        >
                            ...
                            <p className="text-sm text-green-700 font-bold">¡Gracias por tu reseña! Será visible una vez aprobada.</p>
                        </motion.div>
                    )}
