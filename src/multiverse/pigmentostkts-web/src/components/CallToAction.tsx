...
export default function CallToAction() {
    return (
        <section id="cta" data-theme="dark" className="bg-brand-black min-h-screen flex flex-col justify-center py-24 relative overflow-hidden text-center border-t border-brand-yellow/10">
            {/* Background Effects */}
